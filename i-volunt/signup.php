...
// Processing form data when form is submitted
 if(isset($_POST["signupbtn"])) {
    ...
    if(empty($username_err) && empty($password_err)){
        mysqli_query($con, "INSERT INTO person VALUES ('$username', '$password', '$fName', '$mInit', '$lName', '$bday', '$gender', '$pronouns', '0', '1')")  or die ( mysql_error() );
        $date = date('Y/m/d');
        mysqli_query($con, "INSERT INTO volunteer VALUES ('$username', '$date', '2021', '0')")  or die ( mysql_error() );
    }
    mysqli_close($con);
